...
void PieView::paintEvent(QPaintEvent *)
{
    ...
    painter.drawText(20,28,tr("预售面积"));
    for(int i=1;i<5;i++)
    {
    ...
    //x 坐标轴
    painter.drawLine(x0,y0,300,250);
    painter.drawLine(298,248,300,250);
    painter.drawLine(300,250,298,252);
    painter.drawText(302,250,tr("项目名称"));
